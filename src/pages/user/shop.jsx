...
const Shop = ({category}) => {
  ...
  const categories = [
    {
      name: 'Model1',
      img: "https://tse3.mm.bing.net/th?id=OIP.F2b-SiHDDWF-MHHNabH-wQAAAA&pid=Api&P=0&h=220",
    },
    {
      name: 'Model2',
      img: "https://tse4.mm.bing.net/th?id=OIP.ICLNiGgldN8r1wUc1aEvjQHaK0&pid=Api&P=0&h=220",
    },
    {
      name: 'Model3', 
      img: "https://tse2.mm.bing.net/th?id=OIP.LqHRyvG5hQXIUIXfDUpDsAHaOt&pid=Api&P=0&h=220",
    },
  ];
  ...
  return (  
    <>
      ...
      <div className="bg-gradient-to-b from-pink-50 to-pink-100 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 text-xl max-w-2xl mx-auto leading-relaxed">
              Step into a world of handpicked collections that reflect your unique style. Our exclusive range of sarees, girls' wear, boys' wear, and ganzy clothes are chosen with care to match your preferences and elevate your fashion game. Every piece is selected to ensure you feel confident and stylish, no matter the occasion.
            </p>
          </div>
        </section>
        ...
        <footer className="bg-violet-600 py-16 text-white border-t border-pink-200">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-6">
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="flex space-x-6 text-3xl mt-4">
                <FaFacebook className="text-blue hover:text-gray-300 transition cursor-pointer" />
                <FaInstagram className="text-pink hover:text-gray-300 transition cursor-pointer" />
                <FaTwitter className="text-white hover:text-gray-300 transition cursor-pointer" />
              </div>
            </div>
